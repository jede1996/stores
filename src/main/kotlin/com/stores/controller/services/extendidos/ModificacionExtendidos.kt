...
class ModificacionExtendidos  @Autowired constructor(
    ...
    fun modificacionExtendidos(request: Any?, extLunaVetRepository: ExtLunaVetRepository, extCamaDelPerroRepository: ExtCamaDelPerroRepository): ResponseEntity<Any>{
