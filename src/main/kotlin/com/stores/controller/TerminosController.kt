...
class TerminosController {
    ...
    fun lunaVet(model: Model): String {
        model.addAttribute("telefono", "7442130868")
            .addAttribute("direccion", "Av. Las Torres Etapa 38, coloso ruta axtel, El Coloso, 39810 Acapulco de Juárez, Gro.")
    ...
    fun camaDelPerro(model: Model):String  {
        model.addAttribute("telefono", "7442130868")
            .addAttribute("direccion", "Coloso avenida las torres etapa 38")
            .addAttribute("nombre", "Luna Vet")
        return "plantillaVeterinaria"
    }
}